	...
	<?php 
		...
		if(isset($_POST['devolver'])){
			...
			if ($data_mes == 1){
				...
				if(!$sql === false){
					...
					//pesquisar o usuario que está fazendo  lançamento
					...
					//pesquisar quantas sacolas já foram devolvidas 
					...
					echo "<script>alert('Devolvidas Existente: $valor_devolvido Sacolas');</script>";
					...
					echo "<script>alert('Devolvida Atual: $Devolvidas Sacolas');</script>";
					...
					try{
						$conn2->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
						$sql = "UPDATE sacolas_janeiro SET devolvidas = '$soma', created = NOW(),  nome_lancado = '$result_nome'  WHERE operador = '$Operador'AND data = '$Data'";
						$conn2->exec($sql);
					}catch(PDOException $e) {
						echo $sql . "<br>" . $e->getMessage();
					}

					echo "<script>alert('$Nome já Devolveu: $soma Sacolas');</script>";
		...
		if(isset($_POST['devolver'])){
			...
			if ($data_mes == 2){
				...
				if(!$sql === false){
					...
					try{
						$conn2->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
						$sql = "UPDATE sacolas_fevereiro SET devolvidas = '$soma', created = NOW(),  nome_lancado = '$result_nome'  WHERE operador = '$Operador'AND data = '$Data'";
						$conn2->exec($sql);
					}catch(PDOException $e) {
						echo $sql . "<br>" . $e->getMessage();
					}
		...
		if(isset($_POST['devolver'])){
			...
			if ($data_mes == 3){
				...
				if(!$sql === false){
					...
					try{
						$conn2->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
						$sql = "UPDATE sacolas_marco SET devolvidas = '$soma', created = NOW(),  nome_lancado = '$result_nome'  WHERE operador = '$Operador'AND data = '$Data'";
						$conn2->exec($sql);
					}catch(PDOException $e) {
						echo $sql . "<br>" . $e->getMessage();
					}
		...
		if(isset($_POST['devolver'])){
			...
			if ($data_mes == 4){
				...
				try{
					$conn2->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
					$sql = "INSERT INTO sacolas_cpd_abril(id, operador, nome, retirada, devolvidas, data, created, total, nome_lancado) VALUES(null, '$Operador', '$Nome', 0, '$Devolvidas', '$Data', NOW(), 0, '$result_nome')";
					$conn2->exec($sql);
				}catch(PDOException $e) {
					echo $sql . "<br>" . $e->getMessage();
				}
				...
				if(!$sql === false){
					...
					try{
						$conn2->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
						$sql = "UPDATE sacolas_abril SET devolvidas = '$soma', created = NOW(),  nome_lancado = '$result_nome'  WHERE operador = '$Operador'AND data = '$Data'";
						$conn2->exec($sql);
					}catch(PDOException $e) {
						echo $sql . "<br>" . $e->getMessage();
					}
		...
		if(isset($_POST['devolver'])){
			...
			if ($data_mes == 5){
				...
				if(!$sql === false){
					...
					try{
						$conn2->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
						$sql = "UPDATE sacolas_maio SET devolvidas = '$soma', created = NOW(),  nome_lancado = '$result_nome'  WHERE operador = '$Operador'AND data = '$Data'";
						$conn2->exec($sql);
					}catch(PDOException $e) {
						echo $sql . "<br>" . $e->getMessage();
					}
		...
		if(isset($_POST['devolver'])){
			...
			if ($data_mes == 6){
				...
				if(!$sql === false){
					...
					try{
						$conn2->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
						$sql = "UPDATE sacolas_junho SET devolvidas = '$soma', created = NOW(),  nome_lancado = '$result_nome'  WHERE operador = '$Operador'AND data = '$Data'";
						$conn2->exec($sql);
					}catch(PDOException $e) {
						echo $sql . "<br>" . $e->getMessage();
					}
		...
		if(isset($_POST['devolver'])){
			...
			if ($data_mes == 7){
				...
				if(!$sql === false){
					...
					try{
						$conn2->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
						$sql = "UPDATE sacolas_julho SET devolvidas = '$soma', created = NOW(),  nome_lancado = '$result_nome'  WHERE operador = '$Operador'AND data = '$Data'";
						$conn2->exec($sql);
					}catch(PDOException $e) {
						echo $sql . "<br>" . $e->getMessage();
					}
		...
		if(isset($_POST['devolver'])){
			...
			if ($data_mes == 8){
				...
				if(!$sql === false){
					...
					try{
						$conn2->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
						$sql = "UPDATE sacolas_agosto SET devolvidas = '$soma', created = NOW(),  nome_lancado = '$result_nome'  WHERE operador = '$Operador'AND data = '$Data'";
						$conn2->exec($sql);
					}catch(PDOException $e) {
						echo $sql . "<br>" . $e->getMessage();
					}
		...
		if(isset($_POST['devolver'])){
			...
			if ($data_mes == 9){
				...
				if(!$sql === false){
					...
					try{
						$conn2->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
						$sql = "UPDATE sacolas_setembro SET devolvidas = '$soma', created = NOW(),  nome_lancado = '$result_nome'  WHERE operador = '$Operador'AND data = '$Data'";
						$conn2->exec($sql);
					}catch(PDOException $e) {
						echo $sql . "<br>" . $e->getMessage();
					}
		...
		if(isset($_POST['devolver'])){
			...
			if ($data_mes == 10){
				...
				if(!$sql === false){
					...
					try{
						$conn2->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
						$sql = "UPDATE sacolas_outubro SET devolvidas = '$soma', created = NOW(),  nome_lancado = '$result_nome'  WHERE operador = '$Operador'AND data = '$Data'";
						$conn2->exec($sql);
					}catch(PDOException $e) {
						echo $sql . "<br>" . $e->getMessage();
					}
		...
		if(isset($_POST['devolver'])){
			...
			if ($data_mes == 11){
				...
				if(!$sql === false){
					...
					try{
						$conn2->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
						$sql = "UPDATE sacolas_novembro SET devolvidas = '$soma', created = NOW(),  nome_lancado = '$result_nome'  WHERE operador = '$Operador'AND data = '$Data'";
						$conn2->exec($sql);
					}catch(PDOException $e) {
						echo $sql . "<br>" . $e->getMessage();
					}
